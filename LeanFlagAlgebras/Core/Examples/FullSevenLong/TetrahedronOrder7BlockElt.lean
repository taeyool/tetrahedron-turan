...
-- Proof template: scripts/exact_certificate/templates/Examples/TetrahedronOrder7BlockElt.lean; certificate-dependent imports redirected.
...
theorem blockElt6_eq_smul_SOS :
    blockElt6 = ((1 : ℝ) / 4000000000000) • blockSOS := by
  ...
  have hcoeff : (blockNumOf H / 2880000000000000 : ℚ)
      = (1 / 4000000000000 : ℚ)
        * ((((s24C · (repMask H)) <$> facs24L).map (· / 180)).sum
          + (((s45C 0 flags45_0 · (repMask H)) <$> facs45_0L).map
              (· / 720)).sum
    ...
    ring
  rw [show ((blockNumOf H / 2880000000000000 : ℚ) : ℝ)
      = ((1 / 4000000000000 : ℚ) : ℝ)
        * ((((((s24C · (repMask H)) <$> facs24L).map (· / 180)).sum
          + (((s45C 0 flags45_0 · (repMask H)) <$> facs45_0L).map
              (· / 720)).sum
  ...
  rw [show ((1 / 4000000000000 : ℚ) : ℝ) = ((1 : ℝ) / 4000000000000) from by
    norm_num]
